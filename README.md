...
| App           | URL                    |
|---------------|------------------------|
| ConfusedCloud | http://localhost:5000  |
| CyberMart     | http://localhost:5001  |
| FakeCrypto    | http://localhost:5002  |
| HRLeaks       | http://localhost:5003  |
| SkyHack       | http://localhost:5004  |
| VoteVault     | http://localhost:5005  |

> You can change ports in each `docker-compose.yml` file.
...
|------------------|----------------------------------------|---------------------------|
| SQL Injection     | Tamper with DB queries                | ConfusedCloud, CyberMart  |
| NoSQL Injection   | Bypass logic in NoSQL DBs             | CyberMart                 |
| Cross-Site Scripting (XSS) | Inject malicious scripts       | ConfusedCloud, HRLeaks    |
| CSRF             | Exploit user trust                    | ConfusedCloud             |
| IDOR & Access Control | Access unauthorized data         | HRLeaks, SkyHack          |
| SSRF & XXE        | Interact with internal services       | FakeCrypto                |
| Log Injection     | Inject or manipulate logs             | FakeCrypto                |
| File Upload       | Upload dangerous files                | HRLeaks, FakeCrypto       |
